...
OQ.BG_TIME_REMAINING_REGEX  = "Remaining: (%d+)"
OQ.BG_DWG_POINTS_REGEX      = "Bases: (%d+)  Gold: (%d+)"
OQ.BG_TOK_POINTS_REGEX      = "Victory Points: (%d+)"
OQ.BG_SSM_POINTS_REGEX      = "Resources: (%d+)"
OQ.BG_SOTA_ROUND_TIME_REGEX = "End of Round: (%d+:%d+)"
OQ.BG_IOC_POINTS_REGEX      = "Reinforcements: (%d+)"
OQ.BG_EOTS_POINTS_REGEX     = "Bases: (%d+)  Victory Points: (%d+)"
OQ.BG_BFG_POINTS_REGEX      = "Bases: (%d+)  Resources: (%d+)"
OQ.BG_AV_POINTS_REGEX       = "Reinforcements: (%d+)"
OQ.BG_AB_POINTS_REGEX       = "Bases: (%d+)  Resources: (%d+)"
