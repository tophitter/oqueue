...
OQ.BG_STAT_COLUMN = { [ "Баз атаковано"           ] = "Баз атаковано",
                      [ "Баз защищено"            ] = "Баз защищено",
                      [ "Разрушителей уничтожено" ] = "Разрушителей уничтожено",
                      [ "Захваты флага"           ] = "Захваты флага",
                      [ "Возвраты флага"          ] = "Возвраты флага",
                      [ "Врат разрушено"          ] = "Врат разрушено",
                      [ "Штурмы кладбищ"          ] = "Штурмы кладбищ",
                      [ "Оборона кладбищ"         ] = "Оборона кладбищ",
                      [ "Штурмы башен"            ] = "Штурмы башен",
                      [ "Оборона башен"           ] = "Оборона башен",
                    } ;
