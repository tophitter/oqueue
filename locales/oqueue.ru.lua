...
OQ.BG_STAT_COLUMN = { [ "Баз атаковано"           ] = "База атакована",
                      ...
                      [ "Захваты флага"           ] = "Флаг захвачен",
                      [ "Возвраты флага"          ] = "Флаг возвращен",
                      [ "Врат разрушено"          ] = "Ворота разрушены",
                      [ "Штурмы кладбищ"          ] = "Кладбище атаковано",
                      [ "Оборона кладбищ"         ] = "Кладбище защищено",
                      [ "Штурмы башен"            ] = "Башня атакована",
                      [ "Оборона башен"           ] = "Башня защищена",
                      [ "Захваты сферы"           ] = "Сфера захвачена",
                    } ;
