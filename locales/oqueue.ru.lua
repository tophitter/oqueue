...
OQ.LOCAL_OQ_USERS     = "локальные пользователи OQ" ;
OQ.TIME_DRIFT         = "дрейф времени" ;
OQ.PPS_SENT           = "отправка пакетов/сек" ;
OQ.PPS_RECVD          = "прием пакетов/сек" ;
OQ.PPS_PROCESSED      = "обработка пакетов/сек" ;
OQ.MEM_USED           = "использовано памяти (кБ)" ;
...
OQ.STILL_IN_PREMADE   = "пожалуйста выйдите из своего премейда перед созданием нового" ;
...
OQ.CONTRIBUTION_DLG = { "",
                        ...
                        "beg.oq",
                        "",
                        "для Rathamus и публичного Ventrilo:",
                        "beg.vent",
                        "",
                        "Спасибо!",
                        "",
